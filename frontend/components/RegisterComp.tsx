        ...
        <div className="max-w-sm mx-auto px-6">
          <div className="relative flex flex-wrap">
            <div className="w-full relative">
              <div className="mt-6">
                <div className="mb-5 pb-1border-b-2 text-center font-base text-gray-400 text-[2rem] font-bold ">
                  ARZ GOAL
                </div>
                  ...
                  <div className="mx-auto max-w-lg">
                    <div className="py-2 ">
                      ...
                      <input
                        ...
                        className="text-md block px-3 py-2  rounded-lg w-full text-black
                    ...
                    <div className="flex justify-between">
                      ...
                      <label className="block text-gray-500 font-bold my-4">
                        <a
                          href="#"
                          className="cursor-pointer tracking-tighter text-gray-600 hover:text-gray-400 border-b-2 border-gray-600 hover:border-gray-400"
                        >
                    ...
                    <button
                      ...
                      px-6 py-3 block shadow-xl hover:text-white hover:bg-gray-700 transition-all"
                    >
                      Register
                    </button>
                  </div>
